...
import { convertUint8ArrayToBase64, createIdGenerator } from '@ai-sdk/provider-utils';
                    ...
                    ? part.content.map((part) => {
                        switch (part.type) {
                          ...
                          case 'image':
                            ...
                            if (format && !isBedrockImageFormat(format)) {
...
function groupIntoBlocks(prompt: LanguageModelV1Prompt): Array<SystemBlock | AssistantBlock | UserBlock> {
