...
import { convertToConverseCompatibleChatMessages } from './convert-to-converse-compatible-chat-messages';

describe('system messages', () => {
  it('should combine multiple leading system messages into a single system message', async () => {
    const { system } = convertToConverseCompatibleChatMessages([
  ...
  it('should throw an error if a system message is provided after a non-system message', async () => {
    expect(() =>
      convertToConverseCompatibleChatMessages([
  ...
  it('should set isSystemCachePoint when system message has cache point', async () => {
    const result = convertToConverseCompatibleChatMessages([
      {
        role: 'system',
        content: 'Hello',
...
describe('user messages', () => {
  it('should convert messages with file, image, and text parts to multiple parts', async () => {
    ...
    const { messages } = convertToConverseCompatibleChatMessages([
      {
        role: 'user',
        content: [
