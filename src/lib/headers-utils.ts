 ...
 */
export function extractHeaders(headers: HeadersInit | undefined): Record<string, string | undefined> {
  ...
  if (headers) {
    if (headers instanceof Headers) {
      ...
      originalHeaders = Object.fromEntries(Object.entries(headers).map(([k, v]) => [k.toLowerCase(), v])) as Record<string, string>;
    }
  }
 ...
 */
export function convertHeadersToRecord(headers: Headers): Record<string, string> {
