...
import { createConverseCompatibleEventStreamResponseHandler } from './converse-compatible-event-stream-response-handler';
...
describe('createEventSourceResponseHandler', () => {
  ...
  it('throws EmptyResponseBodyError when response body is null', async () => {
    ...
    const handler = createConverseCompatibleEventStreamResponseHandler(testSchema);
